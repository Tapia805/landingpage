---
description: este workflow nos ayudara a commits
---
# ti­tulo: Flujo de Commit y Push en Git
# descripción: Guí­a al usuario a través de un flujo tí­pico de Git - revisar el estado, preparar (staging), hacer commit y hacer push - con puntos de control para confirmación del usuario en cada paso.
